...
/*
 * No hamburger. Below 820px the links become their own horizontally
 * scrollable row, which keeps every destination one tap away instead of
 * two — the site has four pages, a drawer would be ceremony.
 */
export const Nav = () => (
