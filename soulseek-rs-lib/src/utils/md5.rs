...
*/
const fn round_three_operations(
    mut a: u32,
    mut b: u32,
    mut c: u32,
    mut d: u32,
...
*/
const fn round_four_operations(
    mut a: u32,
    mut b: u32,
    mut c: u32,
    mut d: u32,
...
fn compute_md5_digest(mut v: Vec<u8>) -> String {
    ...
    for chunk in v.as_chunks_mut::<64>().0 {
...
const fn split_u64_to_u8_array(s: u64) -> [u8; 8] {
    [
        s as u8,
        (s >> 8) as u8,
        (s >> 16) as u8,
